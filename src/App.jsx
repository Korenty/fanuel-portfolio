            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                activeSection === item.id
                  ? 'bg-blue-600/80 text-white shadow-neon hover:shadow-neon-lg'
  ...
  <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-950 to-gray-800 p-6 relative overflow-hidden">
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 z-10">
      ...
      <div className="lg:w-1/2 relative flex justify-center items-center">
        <div className="w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden bg-white/5 backdrop-blur-md border-4 border-cyan-500/30 shadow-[0_0_15px_rgba(0,119,182,0.3)] transform hover:scale-105 transition-all duration-500">
          <img 
            src="profile.jpg" 
        ...
        <div className="absolute bottom-4 right-4 p-3 bg-cyan-500/20 rounded-full shadow-[0_0_10px_rgba(0,119,182,0.5)]">
  ...
  <section id="about" className="py-20 bg-gray-900/50 backdrop-blur-md p-6">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="p-6 bg-gray-800/50 rounded-xl shadow-[0_0_20px_rgba(0,119,182,0.1)] border-t-4 border-cyan-500/50">
        ...
        <div className="p-6 bg-gray-800/70 rounded-xl shadow-[0_0_20px_rgba(0,119,182,0.2)] border-l-4 border-blue-500/50">
...
const SkillPill = ({ icon, title, level }) => (
  <div className="flex items-center space-x-3 p-3 bg-gray-800/60 rounded-xl shadow-[0_0_10px_rgba(0,119,182,0.1)] hover:shadow-[0_0_15px_rgba(0,119,182,0.3)] transition-all duration-300">
  ...
  <section id="skills" className="py-20 bg-gray-900 p-6">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-6 bg-gray-800/50 rounded-xl shadow-[0_0_20px_rgba(0,119,182,0.1)] border-t-4 border-purple-500/50">
        ...
        <div className="p-6 bg-gray-800/50 rounded-xl shadow-[0_0_20px_rgba(0,119,182,0.1)] border-t-4 border-yellow-500/50">
...
const ProjectCard = ({ title, description, link, stack }) => (
  <div className="bg-gray-800/60 rounded-xl shadow-[0_0_20px_rgba(0,119,182,0.1)] p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(0,119,182,0.3)] transition-all duration-300">
...
export default App;                activeSection === item.id
